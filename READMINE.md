...
<<<<<<< HEAD
     ```console
     git clone --recursive https://github.com/kurt-nj/prezto.git "${ZDOTDIR:-$HOME}/.zprezto"
     ```
=======
      ```console
      git clone --recursive git@github.com:kurt-nj/prezto.git "${ZDOTDIR:-$HOME}/.zprezto"
      ```
>>>>>>> 75b331b88f4e6984ead5caba170431a96262b0d6
